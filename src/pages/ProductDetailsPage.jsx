        ...
        <div className="container mx-auto flex mt-[50px] gap-[20px]">
          ...
          <div className="w-[50%] flex flex-col">
            <img
              ...
              alt=""
              className="w-full h-[500px] object-cover border-2 border-mainBlue p-3 rounded-[20px]"
            />
              ...
              {product.images?.map((img, index) => {
                return (
                  <img
                    ...
                    src={img}
                    alt=""
                    className="w-[100px] h-[100px] border border-mainBlue p-2 rounded-[20px] cursor-pointer"
          ...
          <div className="w-[50%]">
            <div className="flex flex-col gap-3">
              ...
              <h3>
                Hurry up! only{" "}
                <span className="font-bold">{product.stock}</span> product left
                in stock!
              </h3>
            </div>
            ...
            <div className="mt-[50px]">
              <h3 className="text-xl">
                Total Price:{" "}
                <span className="text-mainBlue font-bold text-2xl">
                  ${product.price}
                </span>
              </h3>
              <div className="flex items-center">
              ...
              <div className="flex items-center gap-5 mt-[20px]">
                ...
                >
                  {/* da hnedluje! */}
                  {favoriteIcon === parseInt(id) ? (
                    <FaHeart size={32} color="red" />
                  ) : (
                    <CiHeart size={32} color="white" />
                  )}
                </Link>
              </div>
            </div>
